...
sumPlotFun<-function(parVect,resultList,yVar,yVarAnnot,teThr,teThrAnnot,outDir,dateStr,xlim=2,doPlots=TRUE){
...
sumMods<-sumPlotFun(parVect=parVectTmp,resultList=resultList,yVar=yVar,yVarAnnot=yVarAnnot,teThr=teThr,teThrAnnot=teThrAnnot,outDir=outDir,dateStr=dateStr)
...
sumMods<-sumPlotFun(parVect=parVect,resultList=resultList,yVar=yVar,yVarAnnot=yVarAnnot,teThr=teThr,teThrAnnot=teThrAnnot,outDir=outDir,dateStr=dateStr)
...
sumMods<-sumPlotFun(parVect=parVect,resultList=resultList,yVar=yVar,yVarAnnot=yVarAnnot,teThr=teThr,teThrAnnot=teThrAnnot,outDir=outDir,dateStr=dateStr,xlim=102)
...
sumMods<-sumPlotFun(parVect=parVect,resultList=resultList,yVar=yVar,yVarAnnot=yVarAnnot,teThr=teThr,teThrAnnot=teThrAnnot,outDir=outDir,dateStr=dateStr,xlim=10)
...
```{r modelValidAPRIGPR, fig.width=10, fig.height=5.75}
loadValidation<-TRUE
