...
jagsModel4_te115_apri20 <- jags.model('jagsModel4_IndivAndStudyCovariatesNoBetweenStudyEffects_withAlc.jags', data=datJags, n.chains = 4, n.adapt = 2000)
...
for(i in 1:length(apriVect)){
  ...
  jagsModel4_te115_apri <- jags.model('jagsModel4_IndivAndStudyCovariatesNoBetweenStudyEffects_withAlc.jags', data=datJags, n.chains = 4, n.adapt = 2500)
  parsModel4_te115_apri<-coda.samples(model=jagsModel4_te115_apri,variable.names=c('sens','spec','orGammaS','orGammaN','orGammaL','orGammaA','orLambda','reSens','reSpec'),n.iter=5000)
...
jagsModel4_te95_apri20 <- jags.model('jagsModel4_IndivAndStudyCovariatesNoBetweenStudyEffects_withAlc.jags', data=datJags, n.chains = 4, n.adapt = 2000)
...
jagsModel4_te79_apri15 <- jags.model('jagsModel4_IndivAndStudyCovariatesNoBetweenStudyEffects_withAlc.jags', data=datJags, n.chains = 4, n.adapt = 2000)
...
for(i in 1:length(altVect)){
  ...
  jagsModel4_te115_alt <- jags.model('jagsModel4_IndivAndStudyCovariatesNoBetweenStudyEffects_withAlc.jags', data=datJags, n.chains = 4, n.adapt = 2500)
  parsModel4_te115_alt<-coda.samples(model=jagsModel4_te115_alt,variable.names=c('sens','spec','orGammaS','orGammaN','orGammaL','orGammaA','orLambda','reSens','reSpec'),n.iter=5000)
