...
```{r model0nohet, warning=F, message=F}
datJags<-list()
...
```{r model0withhet, warning=F, message=F}
datJags<-list()
...
jagsModel0_te115_apri20 <- jags.model('jagsModel0_NullWithHet.jags', data=datJags, n.chains = 4, n.adapt = 1000)
parsModel0_te115_apri20<-coda.samples(model=jagsModel0_te115_apri20,variable.names=c('p_sens','p_spec'),n.iter=5000)
dicModel0_te115_apri20<-dic.samples(jagsModel0_te115_apri20,type="pD",n.iter=1000)
...
jagsModel1_te115_apri20 <- jags.model('jagsModel1_NoIndivRandomNoCovariates.jags', data=datJags, n.chains = 4, n.adapt = 1000)
...
This model is quite slow, given that it has a random error for each observation.
R chunk below is skipped / not evaluated.

```{r model2, warning=F, message=F, eval=F}
datJags<-list()
...
jagsModel2_te115_apri20 <- jags.model('jagsModel2_IndivRandomNoCovariates.jags', data=datJags, n.chains = 4, n.adapt = 1000)
parsModel2_te115_apri20<-coda.samples(model=jagsModel2_te115_apri20,variable.names=c('beta'),n.iter=5000)
dicModel2_te115_apri20<-dic.samples(jagsModel2_te115_apri20,type="pD",n.iter=1000) 
...
jagsModel4_te115_apri20 <- jags.model('jagsModel4_IndivAndStudyCovariates.jags', data=datJags, n.chains = 4, n.adapt = 2000)
parsModel4_te115_apri20<-coda.samples(model=jagsModel4_te115_apri20,variable.names=c('beta','gamma1W','gamma1B','gamma2W','gamma2B','gamma3W','gamma3B','gamma4W','gamma4B','lambda'),n.iter=10000)
