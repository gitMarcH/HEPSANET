...
```{r model4NoBetweenStudyEffectsSimple_apri20_te115, warning=FALSE, message=FALSE, error=FALSE, results='hide', eval=F}
datJags<-list()
...
```{r model4NoBetweenStudyEffectsSimple_apri20_te95, warning=FALSE, message=FALSE, error=FALSE, results='hide', eval=F}
datJags<-list()
...
```{r model4NoBetweenStudyEffectsSimple_apri15_te79, warning=FALSE, message=FALSE, error=FALSE, results='hide', eval=F}
datJags<-list()
...
```{r model4NoBetweenStudyEffectsSimple_gpr56_te115, warning=FALSE, message=FALSE, error=FALSE, results='hide', eval=F}
datJags<-list()
...
```{r model4NoBetweenStudyEffectsSimple_gpr56_te95, warning=FALSE, message=FALSE, error=FALSE, results='hide', eval=F}
datJags<-list()
...
```{r model4NoBetweenStudyEffectsSimple_gpr32_te79, warning=FALSE, message=FALSE, error=FALSE, results='hide', eval=F}
datJags<-list()
...
load("fixedThresholdModelsResultsList_20210806.RData")
...
```{r apri115Vect, warning=F, message=F, error=FALSE, results='hide', eval=FALSE}
...
for(i in 1:nrow(dfROC)){
  sensCrI<-as.numeric(unlist(strsplit(split=",",gsub(pattern="\\(|\\)",replacement="",apri115ResultsList[[i]]["overall sensitivity","CrI"]))))
  specCrI<-as.numeric(unlist(strsplit(split=",",gsub(pattern="\\(|\\)",replacement="",apri115ResultsList[[i]]["overall specificity","CrI"]))))
...
ruleInApri115_90_idx<-min(which(dfROC$specificity>=0.9))
ruleInApri115_95_idx<-min(which(dfROC$specificity>=0.95))
ruleOutApri115_70_idx<-max(which(dfROC$sensitivity>=0.7))
ruleOutApri115_80_idx<-max(which(dfROC$sensitivity>=0.8))

dfROC %>% ggplot() +
  geom_point(mapping=aes(x=apri,y=sensitivity,ymin=sensLow,ymax=sensUpp),col="orange",size=2) +
  geom_line(mapping=aes(x=apri,y=sensitivity,ymin=sensLow,ymax=sensUpp),col="orange",lwd=1) +
  geom_ribbon(mapping=aes(x=apri,y=sensitivity,ymin=sensLow,ymax=sensUpp),fill="orange",alpha=0.25) +
  geom_point(mapping=aes(x=apri,y=specificity,ymin=specLow,ymax=specUpp),col="steelblue",size=2) +
  geom_line(mapping=aes(x=apri,y=specificity,ymin=specLow,ymax=specUpp),col="steelblue",lwd=1) +
  geom_ribbon(mapping=aes(x=apri,y=specificity,ymin=specLow,ymax=specUpp),fill="steelblue",alpha=0.25) +
  geom_text(x=2,y=0.9,label=paste(sep="","Rule-in threshold with specificity>0.9: APRI >=",dfROC$apri[ruleInApri115_90_idx]," (sens. = ",format(nsmall=2,round(digits=2,dfROC$sensitivity[ruleInApri115_90_idx])),")"),col="steelblue",hjust=1,vjust=1) +
  geom_text(x=2,y=0.95,label=paste(sep="","Rule-in threshold with specificity>0.95: APRI >=",dfROC$apri[ruleInApri115_95_idx]," (sens. = ",format(nsmall=2,round(digits=2,dfROC$sensitivity[ruleInApri115_95_idx])),")"),col="steelblue",hjust=1,vjust=1) +
  geom_text(x=2,y=0.7,label=paste(sep="","Rule-out threshold with sensitivity>0.7: APRI <",dfROC$apri[ruleOutApri115_70_idx]," (spec. = ",format(nsmall=2,round(digits=2,dfROC$specificity[ruleOutApri115_70_idx])),")"),col="orange",hjust=1,vjust=1) +
  geom_text(x=2,y=0.8,label=paste(sep="","Rule-out threshold with sensitivity>0.8: APRI <",dfROC$apri[ruleOutApri115_80_idx]," (spec. = ",format(nsmall=2,round(digits=2,dfROC$specificity[ruleOutApri115_80_idx])),")"),col="orange",hjust=1,vjust=1) +
  theme_light() +
  labs(title="Sensitivity (orange) and specificity (blue) as a function of APRI (for te>11.5kPa).",caption="Orange = sensitivity, blue = specificity.") +
  scale_x_continuous(limits=c(0,2),name="APRI") +
  ...
  geom_vline(xintercept=max(youdenJ),lty=2,col="darkgrey",lwd=1,alpha=0.5) +
  geom_text(x=max(youdenJ),y=0,col="darkgrey",label=paste(sep="","Youden J threshold (APRI >= ",bestThr,")"),hjust=0,vjust=0)
```
...
```{r apri115Forest, warning=FALSE, fig.cap="Forest plots for APRI with te >= 11.5kPa."}
...
```{r apri95Vect, warning=F, message=F, error=FALSE, results='hide', eval=FALSE}
apriVect<-unique(c(0,1.5,2,round(digits=2,quantile(dat$apri,probs=seq(0,1,length=40)))))
apriVect<-sort(apriVect) # length 43
...
```{r apri95Forest, warning=FALSE, fig.cap="Forest plots for APRI with te >= 9.5kPa."}
...
```{r apri79Vect, warning=F, message=F, error=FALSE, results='hide', eval=FALSE}
apriVect<-unique(c(0,1.5,2,round(digits=2,quantile(dat$apri,probs=seq(0,1,length=40)))))
apriVect<-sort(apriVect) # length 43
...
```{r apri79Forest, warning=FALSE, fig.cap="Forest plots for APRI with te >= 7.9kPa."}
...
```{r gpr115Vect, warning=F, message=F, error=FALSE, results='hide', eval=FALSE}
...
```{r gpr115Forest, warning=FALSE, fig.cap="Forest plots for GPR with te >= 11.5kPa."}
...
```{r gpr95Vect, warning=F, message=F, error=FALSE, results='hide', eval=FALSE}
gprVect<-unique(round(digits=2,quantile(dat$gpr,probs=seq(0,1,length=54),na.rm=T)))
gprVect<-sort(c(0,gprVect,1,2,3,4,5,6,8,10)) # length 40
...
```{r gpr95Forest, warning=FALSE, fig.cap="Forest plots for GPR with te >= 9.5kPa."}
...
```{r gpr79Vect, warning=F, message=F, error=FALSE, results='hide', eval=FALSE}
gprVect<-unique(round(digits=2,quantile(dat$gpr,probs=seq(0,1,length=54),na.rm=T)))
gprVect<-sort(c(0,gprVect,1,2,3,4,5,6,8,10)) # length 40
...
```{r gpr79Forest, warning=FALSE, fig.cap="Forest plots for GPR with te >= 7.9kPa."}
...
```{r alt115Vect, warning=F, message=F, error=FALSE, results='hide', eval=FALSE}
...
```{r alt115Forest, warning=FALSE, fig.cap="Forest plots for ALT with te >= 11.5kPa."}
...
```{r alt95Vect, warning=F, message=F, error=FALSE, results='hide', eval=FALSE}
altVect<-unique(round(digits=0,quantile(dat$alt,probs=seq(0,1,length=52))))
altVect<-c(0,altVect) # length 40
...
```{r alt79Vect, warning=F, message=F, error=FALSE, results='hide', eval=FALSE}
altVect<-unique(round(digits=0,quantile(dat$alt,probs=seq(0,1,length=52))))
altVect<-c(0,altVect) # length 40
...
```{r alt79Forest, warning=FALSE, fig.cap="Forest plots for ALT with te >= 7.9kPa."}
...
```{r fib4115Vect, warning=F, message=F, error=FALSE, results='hide', eval=FALSE}
...
```{r fib4115Forest, warning=FALSE, fig.cap="Forest plots for FIB4 with te >= 11.5kPa."}
...
```{r fib495Vect, warning=F, message=F, error=FALSE, results='hide', eval=FALSE}
fib4Vect<-unique(round(digits=2,quantile(dat$fib4,probs=seq(0,1,length=40))))
fib4Vect<-sort(c(0,fib4Vect,6,10)) # length 43
...
```{r fib479Vect, warning=F, message=F, error=FALSE, results='hide', eval=FALSE}
fib4Vect<-unique(round(digits=2,quantile(dat$fib4,probs=seq(0,1,length=40))))
fib4Vect<-sort(c(0,fib4Vect,6,10)) # length 43
...
```{r fib479Forest, warning=FALSE, fig.cap="Forest plots for FIB4 with te >= 7.9kPa."}
