...
doFixedThrApri20Te122<-TRUE
doFixedThrApri20Te95<-TRUE
doFixedThrApri15Te79<-TRUE
doFixedThrGpr56Te122<-TRUE
doFixedThrGpr56Te95<-TRUE
doFixedThrGpr32Te79<-TRUE
...
doOptApriFixedUlnTe122<-TRUE
doOptApriFixedUlnTe95<-TRUE
doOptApriFixedUlnTe79<-TRUE

doOptGprTe122<-TRUE
doOptGprTe95<-TRUE
doOptGprTe79<-TRUE

doOptGprFixedUlnTe122<-TRUE
doOptGprFixedUlnTe95<-TRUE
doOptGprFixedUlnTe79<-TRUE
...
sumPlotFun<-function(parVect,yVar,yVarAnnot,teThr,teThrAnnot,outDir,dateStr,xlim=2){
  ...
  return(list(auc=auc,bestThr=bestThr,ruleIn90Thr=ruleIn90Thr,ruleIn95Thr=ruleIn95Thr,ruleOut70Thr=ruleOut70Thr,ruleOut80Thr=ruleOut80Thr,sensVect=sensVect,specVect=specVect,ppvVect=ppvVect,npvVect=npvVect))
}
```
...
addPVstoMCMC<-function(mcmcObj,dat){
...
redoMcmcSummary<-function(modObj,resObj,yVar,teThr,parVect,dat){
  for(pars in parVect){
    mod[[paste(sep="_",yVar,"samples",pars)]]<-addPVstoMCMC(mod[[paste(sep="_",yVar,"samples",pars)]],dat=dat)
...
predictSensSpecFromModel<-function(parVect,mcmcSamples,outFile="sensSpecFacetPlots.png",prefix="apriFixedUln_samples",loadFile=NULL,saveFile=NULL,xlims=NULL){
  if(is.null(loadFile)){
    ...
    colnames(newDat)<-c("Intercept","Alc","BMIob","BMIov","BMIun","SexF")
  ...
  predDatAllSum<-predDatAll %>%
    group_by(thr.1,alcohol,BMI,Sex) %>%
    summarise(
  ...
  g<-predDatAllSum %>%
    ...
    facet_wrap(~alcohol+BMI+Sex,ncol=4) +
    xlab("APRI threshold") +
    ylab("Sensitivity (orange) / specificity (blue)") +
    theme_light()
    
  png(outFile,width=12,height=12,units="in",res=450)
  print(g)
  dev.off()
...
fixedThrMods[["apri20_te122_S"]]$parsModel4<-addPVstoMCMC(fixedThrMods[["apri20_te122_S"]]$parsModel4,dat = datS)
...
fixedThrMods[["apri20_te122_L"]]$parsModel4<-addPVstoMCMC(fixedThrMods[["apri20_te122_L"]]$parsModel4,dat = datL)
...
fixedThrMods[["apri20_te95_S"]]$parsModel4<-addPVstoMCMC(fixedThrMods[["apri20_te95_S"]]$parsModel4,dat = datS)
...
fixedThrMods[["apri20_te95_L"]]$parsModel4<-addPVstoMCMC(fixedThrMods[["apri20_te95_L"]]$parsModel4,dat = datL)
...
fixedThrMods[["apri15_te79_S"]]$parsModel4<-addPVstoMCMC(fixedThrMods[["apri15_te79_S"]]$parsModel4,dat = datS)
...
fixedThrMods[["apri15_te79_L"]]$parsModel4<-addPVstoMCMC(fixedThrMods[["apri15_te79_L"]]$parsModel4,dat = datL)
...
fixedThrMods[["gpr56_te122_S"]]$parsModel4<-addPVstoMCMC(fixedThrMods[["gpr56_te122_S"]]$parsModel4,dat = datS)
...
fixedThrMods[["gpr56_te122_L"]]$parsModel4<-addPVstoMCMC(fixedThrMods[["gpr56_te122_L"]]$parsModel4,dat = datL)
...
fixedThrMods[["gpr56_te95_S"]]$parsModel4<-addPVstoMCMC(fixedThrMods[["gpr56_te95_S"]]$parsModel4,dat = datS)
...
fixedThrMods[["gpr56_te95_L"]]$parsModel4<-addPVstoMCMC(fixedThrMods[["gpr56_te95_L"]]$parsModel4,dat = datL)
...
fixedThrMods[["gpr32_te79_S"]]$parsModel4<-addPVstoMCMC(fixedThrMods[["gpr32_te79_S"]]$parsModel4,dat = datS)
...
fixedThrMods[["gpr32_te79_L"]]$parsModel4<-addPVstoMCMC(fixedThrMods[["gpr32_te79_L"]]$parsModel4,dat = datL)
...
fixedThrSumTabApri %>%
  ...
  pack_rows(group_label="Community, routine and unspecified screening.",1,8) %>%
  pack_rows(group_label="Suspected liver disease screening.",8,16) %>%
...
if(doOptApriFixedUlnTe122){
  ...
  result<-redoMcmcSummary(modObj=mod,resObj=result,yVar=yVar,teThr=teThr,parVect=parVectTmp,dat=datS)
...
sumMods<-sumPlotFun(parVect=parVectTmp,yVar=yVar,yVarAnnot=yVarAnnot,teThr=teThr,teThrAnnot=teThrAnnot,outDir=outDir,dateStr=dateStr)
...
if(doOptApriFixedUlnTe122){
  ...
  parVectTmp<-sort(as.numeric(unique(gsub(pattern="[a-zA-Z\\_]*",replacement="",names(mod)))))
  result<-redoMcmcSummary(modObj=mod,resObj=result,yVar=yVar,teThr=teThr,parVect=parVectTmp,dat=datL)
...
```{r apriFixedUln122SubgroupsFacet_L, warning=FALSE, fig.cap="Sensitivities and specifities at different thresholds for subgroups defined by hazardous alcohol usage (yes, no), BMI category (underweight, normal weight, overweight, obese), screening reason (suspected liver disease or routine / community screening) and sex (male, female). Some of these groups have very few positive cases (according to te > 12.2 kPa) hence the coefficient estimates for those parameter combinations are characterised by greater uncertainty and hence resulting in sensitivity curves for some subgroups that are jagged and non-monotonic. The confidence bands are interquartile ranges of the values from the MCMC runs, solid lines are medians computed over the MCMC runs."}
parVectPlot<-sort(unique(as.numeric(gsub(pattern="apriFixedUln_L_samples_",replacement="",grep(value=T,pattern="samples",names(modList$apriFixedUln_L$te122))))))

g<-predictSensSpecFromModel(parVect=parVectPlot,mcmcSamples=modList$apriFixedUln_L$te122,outFile=paste(sep="",outDir,"/sensSpecBySubgroupsFacetPlot_",str_to_title(yVar),"_Te122_",dateStr,".png"),prefix="apriFixedUln_L_samples",loadFile="output/20220301/sensSpecBySubgroupsFacetPlot_Aprifixeduln_l_Te122_20220301.RData",saveFile=NULL,xlims=c(0,2))
...
```{r apriFixedUln79SubgroupsFacet_S, warning=FALSE, fig.cap="Sensitivities and specifities at different thresholds for subgroups defined by hazardous alcohol usage (yes, no), BMI category (underweight, normal weight, overweight, obese), screening reason (suspected liver disease or routine / community screening) and sex (male, female). Some of these groups have very few positive cases (according to te > 7.9 kPa) hence the coefficient estimates for those parameter combinations are characterised by greater uncertainty and hence resulting in sensitivity curves for some subgroups that are jagged and non-monotonic. The confidence bands are interquartile ranges of the values from the MCMC runs, solid lines are medians computed over the MCMC runs."}
parVectPlot<-sort(unique(as.numeric(gsub(pattern="apriFixedUln_S_samples_",replacement="",grep(value=T,pattern="samples",names(modList$apriFixedUln_S$te79))))))

g<-predictSensSpecFromModel(parVect=parVectPlot,mcmcSamples=modList$apriFixedUln_S$te79,outFile=paste(sep="",outDir,"/sensSpecBySubgroupsFacetPlot_",str_to_title(yVar),"_Te79_",dateStr,".png"),prefix="apriFixedUln_S_samples",loadFile="output/20220301/sensSpecBySubgroupsFacetPlot_Aprifixeduln_s_Te79_20220301.RData",saveFile=NULL,xlims=c(0,2))

include_graphics(paste(sep="",outDir,"/sensSpecBySubgroupsFacetPlot_",str_to_title(yVar),"_Te79_",dateStr,".png"))
```
...
```{r apriFixedUln79SubgroupsFacet_L, warning=FALSE, fig.cap="Sensitivities and specifities at different thresholds for subgroups defined by hazardous alcohol usage (yes, no), BMI category (underweight, normal weight, overweight, obese), screening reason (suspected liver disease or routine / community screening) and sex (male, female). Some of these groups have very few positive cases (according to te > 7.9 kPa) hence the coefficient estimates for those parameter combinations are characterised by greater uncertainty and hence resulting in sensitivity curves for some subgroups that are jagged and non-monotonic. The confidence bands are interquartile ranges of the values from the MCMC runs, solid lines are medians computed over the MCMC runs."}
parVectPlot<-sort(unique(as.numeric(gsub(pattern="apriFixedUln_L_samples_",replacement="",grep(value=T,pattern="samples",names(modList$apriFixedUln_L$te79))))))

g<-predictSensSpecFromModel(parVect=parVectPlot,mcmcSamples=modList$apriFixedUln_L$te79,outFile=paste(sep="",outDir,"/sensSpecBySubgroupsFacetPlot_",str_to_title(yVar),"_Te79_",dateStr,".png"),prefix="apriFixedUln_L_samples",loadFile="output/20220301/sensSpecBySubgroupsFacetPlot_Aprifixeduln_l_Te79_20220301.RData",saveFile=NULL,xlims=c(0,2))
...
```{r gprFixedUln122SubgroupsFacet_S, warning=FALSE, fig.cap="Sensitivities and specifities at different thresholds for subgroups defined by hazardous alcohol usage (yes, no), BMI category (underweight, normal weight, overweight, obese), screening reason (suspected liver disease or routine / community screening) and sex (male, female). Some of these groups have very few positive cases (according to te > 12.2 kPa) hence the coefficient estimates for those parameter combinations are characterised by greater uncertainty and hence resulting in sensitivity curves for some subgroups that are jagged and non-monotonic. The confidence bands are interquartile ranges of the values from the MCMC runs, solid lines are medians computed over the MCMC runs."}
parVectPlot<-sort(unique(as.numeric(gsub(pattern="gprFixedUln_S_samples_",replacement="",grep(value=T,pattern="samples",names(modList$gprFixedUln_S$te122))))))

g<-predictSensSpecFromModel(parVect=parVectPlot,mcmcSamples=modList$gprFixedUln_S$te122,outFile=paste(sep="",outDir,"/sensSpecBySubgroupsFacetPlot_",str_to_title(yVar),"_Te122_",dateStr,".png"),prefix="gprFixedUln_S_samples",loadFile="output/20220301/sensSpecBySubgroupsFacetPlot_Gprifixeduln_s_Te122_20220301.RData",saveFile=NULL,xlims=c(0,2))
...
```{r gprFixedUln122SubgroupsFacet_L, warning=FALSE, fig.cap="Sensitivities and specifities at different thresholds for subgroups defined by hazardous alcohol usage (yes, no), BMI category (underweight, normal weight, overweight, obese), screening reason (suspected liver disease or routine / community screening) and sex (male, female). Some of these groups have very few positive cases (according to te > 12.2 kPa) hence the coefficient estimates for those parameter combinations are characterised by greater uncertainty and hence resulting in sensitivity curves for some subgroups that are jagged and non-monotonic. The confidence bands are interquartile ranges of the values from the MCMC runs, solid lines are medians computed over the MCMC runs."}
parVectPlot<-sort(unique(as.numeric(gsub(pattern="gprFixedUln_L_samples_",replacement="",grep(value=T,pattern="samples",names(modList$gprFixedUln_L$te122))))))

g<-predictSensSpecFromModel(parVect=parVectPlot,mcmcSamples=modList$gprFixedUln_L$te122,outFile=paste(sep="",outDir,"/sensSpecBySubgroupsFacetPlot_",str_to_title(yVar),"_Te122_",dateStr,".png"),prefix="gprFixedUln_L_samples",loadFile="output/20220301/sensSpecBySubgroupsFacetPlot_Gprifixeduln_l_Te122_20220301.RData",saveFile=NULL,xlims=c(0,2))
...
```{r gprFixedUln79SubgroupsFacet_S, warning=FALSE, fig.cap="Sensitivities and specifities at different thresholds for subgroups defined by hazardous alcohol usage (yes, no), BMI category (underweight, normal weight, overweight, obese), screening reason (suspected liver disease or routine / community screening) and sex (male, female). Some of these groups have very few positive cases (according to te > 12.2 kPa) hence the coefficient estimates for those parameter combinations are characterised by greater uncertainty and hence resulting in sensitivity curves for some subgroups that are jagged and non-monotonic. The confidence bands are interquartile ranges of the values from the MCMC runs, solid lines are medians computed over the MCMC runs."}
parVectPlot<-sort(unique(as.numeric(gsub(pattern="gprFixedUln_S_samples_",replacement="",grep(value=T,pattern="samples",names(modList$gprFixedUln_S$te79))))))

g<-predictSensSpecFromModel(parVect=parVectPlot,mcmcSamples=modList$gprFixedUln_S$te79,outFile=paste(sep="",outDir,"/sensSpecBySubgroupsFacetPlot_",str_to_title(yVar),"_Te79_",dateStr,".png"),prefix="gprFixedUln_S_samples",loadFile="output/20220301/sensSpecBySubgroupsFacetPlot_Gprifixeduln_s_Te79_20220301.RData",saveFile=NULL,xlims=c(0,2))
...
```{r gprFixedUln79SubgroupsFacet_L, warning=FALSE, fig.cap="Sensitivities and specifities at different thresholds for subgroups defined by hazardous alcohol usage (yes, no), BMI category (underweight, normal weight, overweight, obese), screening reason (suspected liver disease or routine / community screening) and sex (male, female). Some of these groups have very few positive cases (according to te > 12.2 kPa) hence the coefficient estimates for those parameter combinations are characterised by greater uncertainty and hence resulting in sensitivity curves for some subgroups that are jagged and non-monotonic. The confidence bands are interquartile ranges of the values from the MCMC runs, solid lines are medians computed over the MCMC runs."}
parVectPlot<-sort(unique(as.numeric(gsub(pattern="gprFixedUln_L_samples_",replacement="",grep(value=T,pattern="samples",names(modList$gprFixedUln_L$te79))))))

g<-predictSensSpecFromModel(parVect=parVectPlot,mcmcSamples=modList$gprFixedUln_L$te79,outFile=paste(sep="",outDir,"/sensSpecBySubgroupsFacetPlot_",str_to_title(yVar),"_Te79_",dateStr,".png"),prefix="gprFixedUln_L_samples",loadFile="output/20220301/sensSpecBySubgroupsFacetPlot_Gprifixeduln_l_Te79_20220301.RData",saveFile=NULL,xlims=c(0,2))
